<x-guest-layout>
    <main
        ...
        <div aria-hidden="true"
            class="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(15,23,42,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(15,23,42,0.05)_1px,transparent_1px)] bg-[size:46px_46px] opacity-40 [mask-image:linear-gradient(to_bottom,black,transparent_78%)]">
        </div>
        <div aria-hidden="true"
            class="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-white/80 to-transparent"></div>
            ...
            <section class="w-full">
                <div
                    ...
                    <div class="mb-7">
                        ...
                        <div class="mt-7">
                            <h2 class="text-2xl font-semibold leading-tight text-slate-950">Reset Password</h2>
