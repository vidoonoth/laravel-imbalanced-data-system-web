<x-guest-layout>
    <main
        ...
        <div aria-hidden="true" class="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-white/80 to-transparent"></div>
            ...
            <section class="w-full">
                <div
                    ...
                    <div class="mb-7">
                        ...
                        <div class="mt-7">
                            <h2 class="text-2xl font-semibold leading-tight text-slate-950">Masuk</h2>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <label for="remember_me" class="flex items-center gap-3 text-sm text-slate-600">
                                <input id="remember_me" type="checkbox"
                                    class="h-4 w-4 rounded border-slate-300 bg-white/80 text-cyan-600 shadow-sm focus:ring-cyan-500"
                                    name="remember">
                                <span>Ingat saya</span>
                            </label>

                            @if (Route::has('password.request'))
                                <a class="text-sm font-medium text-cyan-700 transition hover:text-cyan-900 focus:outline-none focus:ring-4 focus:ring-cyan-100"
