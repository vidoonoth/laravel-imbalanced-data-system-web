                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-2 max-w-2xl">
                                    @forelse ($permissionNames->take(4) as $permission)
                                        <span class="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs font-medium">
                                            {{ $permission }}
                                        </span>
                                    @empty
                                        <span class="text-gray-500">Belum ada akses</span>
                                    @endforelse

                                    @if ($permissionNames->count() > 4)
                                        <span class="px-2 py-1 bg-gray-900 text-white rounded text-xs font-medium">
                                            +{{ $permissionNames->count() - 4 }}
                                        </span>
                                    @endif
                                </div>
                            </td>
